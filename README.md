...
# MIL
  Slide classification with attention-based MIL. Please refer to the example label csv file (example_label_file.csv). The task must be same as the label column name in the label csv file.  
```python
