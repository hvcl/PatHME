...
from dinov2.models import build_model_from_cfg_s2
...
class SSLMetaArch_s2(nn.Module):
    def __init__(self, cfg):
        ...
        student_backbone, teacher_backbone, embed_dim = build_model_from_cfg_s2(cfg)
    ...
    def forward_backward(self, images, teacher_temp):
        ...
        def get_teacher_output():
            ...
            #print (f'ibot_teacher_patch_tokens: {ibot_teacher_patch_tokens.shape}' )
