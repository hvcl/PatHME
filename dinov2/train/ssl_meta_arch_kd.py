...
class SSLMetaArch(nn.Module):
    ...
    def forward_backward(self, images, teacher_temp):
        ...
        def get_teacher_output():
            ...
            #print ('x: ', x.shape, n_global_crops_teacher)
            ...
            if do_hmsa:
                ...
                #print ('Doing non hmsa')
                teacher_backbone_output_dict = self.teacher.backbone(x , is_training=True)
            
            #print ('teacher: ', teacher_backbone_output_dict.keys())
        ...
        if do_ibot:
            ...
            #print (ibot_student_patch_tokens.shape,buffer_tensor_patch_tokens.shape )
        # 2: run
        ...
        #if n_local_crops == 1:
        #student_local_cls_tokens_after_head = outputs_list.pop(0).unsqueeze(0)
        #else:    
        student_local_cls_tokens_after_head = outputs_list.pop(0).squeeze(0)

        # 3b: global crops cls tokens
        #if n_local_crops == 1:
        #    student_global_cls_tokens_after_head = outputs_list.pop(0).unsqueeze(0)
        #else:
        ...
        #print (len(student_local_cls_tokens_after_head), len(teacher_dino_softmaxed_centered_list))
        if n_local_crops > 0:
        ...
        if do_ibot:
            # compute loss
            #print ('ibot', student_global_masked_patch_tokens_after_head.shape, masked_teacher_ibot_softmaxed_centered.shape)
            ibot_patch_loss = (
        ...
        if do_hmsa:
            #print (teacher_backbone_output_dict.keys())
