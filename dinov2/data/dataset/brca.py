...
class brca(ExtendedVisionDataset):
    def __init__(self, dataroot, transform):
        ...
        #print (self.seq_list[:3])
        self.transform = transform
        
    def __getitem__(self, index):
        seq = torch.tensor(np.load(self.seq_list[index], allow_pickle=True))#.permute(1, 0)
...
class brca_s2(ExtendedVisionDataset):
