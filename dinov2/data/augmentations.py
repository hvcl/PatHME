...
class DataAugmentationDINO_LG(object):
    ...
    def __call__(self, features):
        ...
        if self.kd > 0:
            ...
            # fm_feature2 = torch.tensor(features[2])
            # fm_feature2 = torch.nan_to_num(fm_feature2, nan=0.0)
            #print (fm_feature.shape, fm_feature2.shape)
            ...
            output["fm_features"] = fm_feature.unsqueeze(0)
            # output["fm_features2"] = fm_feature2.unsqueeze(0)
        else:
        ...
        #output["L0_crops"]  = global_crop_2.transpose(1,0).view(-1,reshape_L0,reshape_L0).unsqueeze(0)
